...
import 'package:web_db/u%C4%B1/view/basket/buying.dart';
...
import 'package:web_db/model/basket/uptade_quantity.dart';
import 'package:web_db/model/coupon/coupon_model.dart';
import 'package:web_db/service/basket/empty_basket_service.dart';
import 'package:web_db/service/basket/get_basket_service.dart';
import 'package:web_db/service/basket/uptade_quantity.dart';
import 'package:web_db/service/coupon/get_user_coupon.dart';
import 'package:web_db/settings/route_settings.dart';
import 'package:web_db/state/basket_state.dart';
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: ListTile(
                                                      leading: const Icon(
                                                          ...
                                                          size: 20),
                                                      title: Text(
                                                          "Tahmini ${DateTime.now().add(const Duration(days: 3)).weekday} ${getDaysName(DateFormat('EEEE').format(DateTime.now().add(const Duration(days: 3))))} kapında"),
                                                      titleTextStyle:
                                                          const TextStyle(
                                                              fontSize: 15),
                                                    ),
...
String getDaysName(String daysName) {
  switch (daysName) {
    case 'Monday':
      return 'Pazartesi';
    case 'Thursday':
